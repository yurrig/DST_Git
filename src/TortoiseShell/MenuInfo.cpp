...
//		{ITEMIS_IGNORED, 0}, {0, 0}, {0, 0}, {0, 0} },
	...
	{ ShellMenuDstWorktreeAdd,				MENUDSTWORKTREEADD,	IDI_COPY,				IDS_MENUDSTWORKTREEADD,		IDS_MENUDESCDSTWORKTREEADD,
		{ITEMIS_FOLDERINGIT|ITEMIS_ONLYONE, 0 }, {ITEMIS_BAREREPO, 0}, {0, 0}, {0, 0} },

	{ ShellMenuDstWorktreeRemove,			MENUDSTWORKTREEDROP,	IDI_COPY,			IDS_MENUDSTWORKTREEREMOVE,	IDS_MENUDESCDSTWORKTREEREMOVE,
		{ITEMIS_FOLDERINGIT|ITEMIS_WORKTREE|ITEMIS_ONLYONE, 0 }, {ITEMIS_BAREREPO, 0}, {0, 0}, {0, 0} },

	{ ShellMenuDstOpenCAM350Solution,		MENUDSTOPENCAM350,		IDI_VISUALSTUDIO,	IDS_MENUDSTOPENCAM350,		IDS_MENUDESCDSTOPENCAM350,
		{ITEMIS_FOLDERINGIT|ITEMIS_HASCAM350|ITEMIS_ONLYONE, 0 }, {0, 0}, {0, 0}, {0, 0} },

	{ ShellMenuDstOpenBluePrintSolution,	MENUDSTOPENBLUEPRINT,	IDI_VISUALSTUDIO,	IDS_MENUDSTOPENBLUEPRINT,	IDS_MENUDESCDSTOPENBLUEPRINT,
		{ITEMIS_FOLDERINGIT|ITEMIS_HASBP|ITEMIS_ONLYONE, 0 }, {0, 0}, {0, 0}, {0, 0} },
